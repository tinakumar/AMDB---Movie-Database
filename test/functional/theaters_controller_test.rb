...
class TheatersControllerTest < ActionController::TestCase
  ...
  test "should create theater" do
    assert_difference('Theater.count') do
      post :create, theater: { address: @theater.address, created_at: @theater.created_at, name: @theater.name, updated_at: @theater.updated_at }
    end
  ...
  test "should update theater" do
    put :update, id: @theater, theater: { address: @theater.address, created_at: @theater.created_at, name: @theater.name, updated_at: @theater.updated_at }
    assert_redirected_to theater_path(assigns(:theater))
  end
